                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    <label class="block mb-1" for="formGridCode_card">Quantity<span
                                            class="text-red-600 text-sm">*</span></label>
                                    <input name="qty" placeholder="10" value="{{ old('qty', $product->qty) }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        type="number" min="0" />
                                    <div class="my-2 ">
                                        @error('qty')
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    <label class="block mb-1" for="formGridCode_card">Price/day<span
                                            class="text-red-600 text-sm">*</span></label>
                                    <input name="price" placeholder="200000"
