    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @if (!Auth::user())
                    <a class=" btn btn-sm inline-flex items-center border border-transparent text-sm leading-4 font-medium rounded-md  text-white bg-indigo-500  py-2 px-6 focus:outline-none hover:bg-indigo-600  hover:text-gray-100  transition ease-in-out duration-150"
                        href="{{ route('login') }}">
                        Login
                    </a>
                @else
