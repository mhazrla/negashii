            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form class="space-y-4 text-gray-700" method="post"
                        action="{{ route('achievement.update', $achievement->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class="flex flex-wrap -mx-2 space-y-4 md:space-y-0">
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    ...
                                    <input name="title" placeholder="Achievement Title"
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    <label class="block mb-1" for="date">Date<span
                                            class="text-red-600 text-sm">*</span></label>
                                    <input name="date" value="{{ old('date', $achievement->date) }}"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        type="date" />
                                    <div class="my-2 ">
                                        @error('date')
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('subtitle1', $achievement->subtitle1) }}">
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('subtitle2', $achievement->subtitle2) }}">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                ...
                                <textarea id="desc2" name="desc2" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius pulvinar mauris ut vulputate. Praesent pretium metus eget blandit consequat. Maecenas malesuada sapien nec sagittis molestie. Ut neque purus, scelerisque quis tellus quis, ultricies venenatis lectus. Sed volutpat sapien blandit metus auctor, at ultricies mi pretium. Morbi eu aliquet enim. Proin ac egestas lectus. ">{{ old('desc2', $achievement->desc2) }}</textarea>
                                <div class="my-2 ">
                                    @error('desc2')
                                        <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('subtitle3', $achievement->subtitle3) }}">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                ...
                                <textarea id="desc3" name="desc3" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius pulvinar mauris ut vulputate. Praesent pretium metus eget blandit consequat. Maecenas malesuada sapien nec sagittis molestie. Ut neque purus, scelerisque quis tellus quis, ultricies venenatis lectus. Sed volutpat sapien blandit metus auctor, at ultricies mi pretium. Morbi eu aliquet enim. Proin ac egestas lectus. ">{{ old('desc3', $achievement->desc3) }}</textarea>
                                <div class="my-2 ">
                                    @error('desc3')
                                        <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="w-full px-2 md:w-1/2">
                                <div class="mb-6">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('subtitle4', $achievement->subtitle4) }}">
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full">
                                ...
                                <textarea id="desc4" name="desc4" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean varius pulvinar mauris ut vulputate. Praesent pretium metus eget blandit consequat. Maecenas malesuada sapien nec sagittis molestie. Ut neque purus, scelerisque quis tellus quis, ultricies venenatis lectus. Sed volutpat sapien blandit metus auctor, at ultricies mi pretium. Morbi eu aliquet enim. Proin ac egestas lectus. ">{{ old('desc4', $achievement->desc4) }}</textarea>
                                <div class="my-2 ">
                                    @error('desc4')
                                        <span class="text-red-600 text-sm">{{ $message }}</span>
                                    @enderror
